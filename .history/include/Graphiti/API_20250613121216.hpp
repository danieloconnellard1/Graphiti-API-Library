...
public:
     ...
     * @brief Draw Event
     * 
     * @param length amount of pins in draw event
     * @param pins pins as PinInfo of length given
     */
    struct DrawEvent {
        int length;
     ...
     */
    void showMessage(std::string message, int blinkRate);
...
private:
     ...
     * 
     * @param funtion_name name of function
     * @param event name of event for output
     * @param length_bytes length in bytes of ascii response for decoding
     */
    struct ResponseInfo {

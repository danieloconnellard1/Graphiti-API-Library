...
const char* getNextDisplayStatusEvent(GraphitiHandle* handle);
const char* getNextKeyEvent(GraphitiHandle* handle);
const char* getNextGestureEvent(GraphitiHandle* handle);

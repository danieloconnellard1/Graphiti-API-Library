...
public:
    ...
    /**
     * @brief 4.2.1 Read Software Version
     * 
    ...
    /**
     * @brief 4.2.2 Read Hardware Version
     * 
    ...
    /**
     * @brief 4.2.3 Read Unit Serial Number
     * 
    ...
    /**
     * @brief 4.2.4 Read Battery Status
     * 
    ...
    /**
     * @brief 4.2.5 Read Resolution Information
     * 
    ...
    /**
     * @brief 4.2.6 Read Device Orientation
     * 
    ...
    /**
     * @brief 4.2.7 Read Height Information
     * 
     ...
     */
    void updateSinglePixel(int row, int column, int height, int blinkRate);
     ...
     * @param rowData 
     */
    void updateSingleRow(int row, std::vector<uint8_t> rowData);
     ...
     */
    void updateSingleColumn(int column, std::vector<uint8_t> columnData);
     ...
     * @param column column ID 1 to 60 
     */
    void getSinglePixelPositionStatus(int row, int column);
     ...
     * @param blinkRate blink rate 0 to 50 (5 seconds) 
     */
    void showMessage(std::string message, std::vector<uint8_t> selectFlags, int blinkRate);
     ...
     */
    void setCursor(int row, int column, int height, int length, int blinkRate);

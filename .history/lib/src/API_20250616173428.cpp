...
void Graphiti_API::updateSinglePixel(int row, int column, int height, int blinkRate) {
...
void Graphiti_API::updateSingleRow(int row, std::vector<uint8_t> rowData) {
    rowData.insert(rowData.begin(), static_cast<uint8_t>(row));
    Graphiti_IO_Write(startOfFrameCheck(rowData, 0x18));
}

void Graphiti_API::updateSingleColumn(int column, std::vector<uint8_t> columnData) {
...
void Graphiti_API::getSinglePixelPositionStatus(int row, int column) {
    Graphiti_IO_Write(startOfFrameCheck({
        static_cast<uint8_t>(row), 
        static_cast<uint8_t>(column) }, 
        0x21)
...
void Graphiti_API::setDateAndTime(int day, int month, int year, int hour, int minute, int second) {
    Graphiti_IO_Write(startOfFrameCheck({ 

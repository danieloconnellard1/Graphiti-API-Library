...
class Graphiti:
    ...
    def _setup_types(self):
        ...
        # status calls
        self._lib.graphiti_updateSinglePixel.argtypes = [c_void_p]
        self._lib.graphiti_updateSinglePixel.restype = None
        self._lib.graphiti_updateSinglePixel.argtypes = [c_void_p, c_int, c_int]
        self._lib.graphiti_updateSinglePixel.restype = None
        self._lib.graphiti_updateSinglePixel.argtypes = [c_void_p, c_int]
        self._lib.graphiti_updateSinglePixel.restype = None
        self._lib.graphiti_updateSinglePixel.argtypes = [c_void_p, c_int]
        self._lib.graphiti_updateSinglePixel.restype = None

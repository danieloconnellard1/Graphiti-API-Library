...
void Tests::registerTests(){
    testRegistry = {
        ...
        //Show Message Test
        {"show_Message_On_The_Device_Functionality", {[this]() { return send_Image_Functionality(); }, false, false }},
        //Set Cursor Test
        {"set_Cursor_Functionality", {[this]() { return send_Image_Functionality(); }, false, false }},
        //Image Test
        {"send_Image_Functionality", {[this]() { return send_Image_Functionality(); }, false, false }},
        //Vibrator Test
        {"vibrator_Control_Command_Functionality", {[this]() { return send_Image_Functionality(); }, false, false }},
        //Clock Test
        {"get_Date_And_Time_Correctness", {[this]() { return send_Image_Functionality(); }, false, false }},
        {"set_Date_And_Time_Correctness", {[this]() { return send_Image_Functionality(); }, false, false }}
    };
}
...
bool Tests::get_Date_And_Time_Correctness() {
    ...
    return sleepAndTest(std::put_time(std::localtime(&now_time), "%Y-%m-%d %H:%M:%S"));
}
